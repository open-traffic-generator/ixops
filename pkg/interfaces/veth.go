...
func CreateVethPair(ifcA string, ifcZ string) error {
	log.Info().Str("ifcA", ifcA).Str("ifcZ", ifcZ).Msg("Creating veth pair")
	commands := []string{
	...
	log.Info().Msg("Created veth pair")
	return nil
}

func DeleteVethPair(ifcA string, ifcZ string) error {
	log.Info().Str("ifcA", ifcA).Str("ifcZ", ifcZ).Msg("Deleting veth pair")
	commands := []string{
	...
	log.Info().Msg("Deleted veth pair")
	return nil
}
